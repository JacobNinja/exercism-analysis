...
require File.expand_path('../exercism-analysis/processors/loop_conditional_processor', __FILE__)
...
require File.expand_path('../exercism-analysis/analyzers/ruby/loop_conditional', __FILE__)
